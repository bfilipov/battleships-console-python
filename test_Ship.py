...
class TestShip(unittest.TestCase):
	...
	def test_ship_length_4(self):
		...
		for i in range(ship2.length):
				self.assertEqual(gb.invisibleGameboard[ship2._shipCoordinatesY[i]][ship2._shipCoordinatesX[i]], "X")
	...
	def test_ship_length_3(self):
		...
		for i in range(ship3.length):
			self.assertEqual(gb.invisibleGameboard[ship3._shipCoordinatesY[i]][ship3._shipCoordinatesX[i]], "X")
	...
	def test_destroyer(self):
		...
		for i in range(destroyer1.length):
			self.assertEqual(gb.invisibleGameboard[destroyer1._shipCoordinatesY[i]]
	...
	def test_battleship(self):
		...
		for i in range(battleship1.length):
			self.assertEqual(gb.invisibleGameboard[battleship1._shipCoordinatesY[i]]
	...
	def test_is_any_dead(self):
		...
		for i in range(battleship1.length):
			gb.visibleGameboard[battleship1._shipCoordinatesY[i]]
			[battleship1._shipCoordinatesX[i]] = "X"
		...
		for i in range(destroyer1.length):
			gb.visibleGameboard[destroyer1._shipCoordinatesY[i]][destroyer1._shipCoordinatesX[i]] = "X"

		self.assertTrue(Ship.is_any_dead(gb))
		self.assertFalse(Ship.is_any_dead(gb))

		for i in range(destroyer2.length):
			gb.visibleGameboard[destroyer2._shipCoordinatesY[i]][destroyer2._shipCoordinatesX[i]] = "X"
